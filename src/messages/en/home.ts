const home = {
  ...
  aboutPreview: {
    ...
    text: "At ProMassage, the focus is on helping each client feel better through therapeutic care that is attentive and purposeful. Every session is approached with professionalism, respect, and an understanding that no two bodies carry tension in exactly the same way.",
    cta: "Learn More",
  },
  faqPreview: {
