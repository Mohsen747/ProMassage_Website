        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-brand-600 text-white font-medium rounded-sm hover:bg-brand-700 transition-colors duration-200"
            >
              {problemSolution.cta}
            </Link>
          </div>
